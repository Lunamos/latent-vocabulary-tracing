...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("foo_bar", "programming_lexicon"),
        (" for", "general_language"),
        (" with", "general_language"),
        (" from", "general_language"),
        (" this", "general_language"),
        (" new", "general_language"),
        ("ING", "general_language"),
        ("__", "formatting"),
        ("\n\n", "formatting"),
        (" the", "general_language"),
        ("数学", "other"),
